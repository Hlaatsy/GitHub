...
class ProviderTests(unittest.TestCase):
    def setUp(self):
        ...
        self.avatar = self.provider.build_avatar("photo", b"face")
    ...
    def test_short_video_sends_on_whatsapp_unchanged(self):
        render = self.provider.render(self.avatar, "hi", 45, "cloned")
    ...
    def test_full_length_video_needs_a_second_encode(self):
        ...
        render = self.provider.render(self.avatar, "hi", 120, "cloned")
    ...
    def test_renders_are_deterministic(self):
        a = self.provider.render(self.avatar, "same", 30, "cloned")
        b = self.provider.render(self.avatar, "same", 30, "cloned")
